...
public class StudentExamApiUtils {

    public static String formatDate (Date date) {
        if (date == null)
            return null;

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(StudentExamApiConstants.DEFAULT_DATE_FORMAT);
    ...
    public static String parseTraxDate (String sessionDate) {
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(StudentExamApiConstants.TRAX_DATE_FORMAT);
        Date date = new Date();
